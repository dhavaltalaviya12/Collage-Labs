...
--5. Delete Column City from the DEPOSIT table.
	ALTER TABLE DEPOSIT_DETAILS DROP COLUMN CITY
--6. Change name of table DEPOSIT to DEPOSIT_DETAIL.	SP_RENAME 'DEPOSIT', 'DEPOSIT_DETAILS'	SELECT * FROM DEPOSIT_DETAILS--Part – B:
--1. Rename Column ADATE to AOPENDATE OF DEPOSIT_DETAIL table.
	SP_RENAME 'DEPOSIT_DETAILS.ADATE', 'AOPEDATE'
--2. Delete Column AOPENDATE from the DEPOSIT_DETAIL table.
	ALTER TABLE DEPOSIT_DETAILS DROP COLUMN AOPEDATE
...
INSERT INTO EMPLOYEE_MASTER VALUES(104,'BHOOMI',2005-06-23,12500,'AHEMDABAD')
...
--5. Delete the records of Employees whose salary is 50% of 20000.
	DELETE FROM EMPLOYEE_MASTER WHERE (0.5*SALARY) = 20000
